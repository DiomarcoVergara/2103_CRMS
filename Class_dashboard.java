...
public class Class_dashboard extends javax.swing.JFrame {
    ...
    public Class_dashboard(int classId, String className, int teacherId) {
        ...
        this.teacherId = teacherId; // Store Teacher_ID
        System.out.println("Class ID: " + classId); // Debugging
        System.out.println("Class Name: " + className); // Debugging
        System.out.println("Teacher ID: " + teacherId); // Debugging
        initComponents();
        setTitle("Class Dashboard - " + className);
        populateClassDetails();
        loadAnnouncements();
        loadStudents(); // Load students after announcements and class details
    }
    ...
    if (announcement.isEmpty()) {
        ...
        // Now, proceed with posting the announcement
        try (Connection conn = new DBConnect().getConnection()) {
...
private void loadStudents() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Class_dashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
