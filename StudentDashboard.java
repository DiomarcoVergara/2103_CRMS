...
import UI.Student_Class_Dashboard;
...
public class StudentDashboard extends javax.swing.JFrame {
    ...
    if (loggedInUser != null) {
        ...
        try {
            this.konek = DatabaseConnector.getConnection(); // Use singleton for DB connection
    ...
    // Load the classes after the UI components are initialized
    loadClasses();
}
    ...
    // SQL Query to fetch classes where the student is enrolled
