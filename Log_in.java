...
public class Log_in extends javax.swing.JFrame {
    ...
    String password = new String(PasswordTextField.getPassword()); // Convert password to String

    User user = new User(email, password);

    if (user.login()) {
        dispose(); // Close the login window
        JOptionPane.showMessageDialog(this, "Login successful!"); // Optional: Display login success message
    } else {
